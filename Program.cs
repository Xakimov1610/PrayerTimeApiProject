...
namespace lesson10
{
    class Program
    {
        ...
        // private static string prayerTimeApi = &$"http://api.aladhan.com/v1/timingsByCity?city={city}&country={country}&method=8";
        static async Task Main(string[] args)
        {
            System.Console.Write("Enter a city: ");
            var city = Console.ReadLine();
            System.Console.Write("Enter a country: ");
            var country = Console.ReadLine();
            var prayerTimeApi = Place(city,country);
